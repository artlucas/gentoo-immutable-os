...
Item {
    ...
    ColumnLayout {
        ...
        // ---- the decisions -----------------------------------------------------------------
        // One border round the whole table and a hairline between rows, which is the design
        // system's shape for a list of facts: nothing here is a choice and nothing is clickable,
        // so a card per row would be promising an interaction the page does not have.
        Rectangle {
            Layout.fillWidth: true
